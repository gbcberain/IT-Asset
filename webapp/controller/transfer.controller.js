...
sap.ui.define([
	...
	return Controller.extend("zgazets.zit.controller.transfer", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf zgazets.zit.view.transfer
		 */
		onInit: function () {
		...
		onSave: function (oSave) {
		   ...
		   var idx;
			...
			//	toempid = table[i].mAggregations.cells[4].mProperties.value; //get asset id
				toDate = table[i].mAggregations.cells[4].mProperties.value; //table[i].oBindingContexts.undefined.oModel.oData.results[i].transferdate;
				...
				oModel.create("/assetTransferSet",
							assetEntry ,  {
